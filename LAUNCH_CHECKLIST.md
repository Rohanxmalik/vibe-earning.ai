...
- [ ] **Managed PostgreSQL + Redis** (most hosts offer these as add-ons).
...
- **Done looks like:** the website + API are live on your domain, 24/7. (The CD pipeline already builds the app images automatically.)
...
- [ ] **Terms of Service + Privacy Policy** for both advertisers and developers (a lawyer or a template service).
